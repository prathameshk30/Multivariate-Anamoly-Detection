...
Link:- https://catalog.data.gov/dataset/cairsense-denver
...
## Methods:-
1) The link to EDA using one specific sensor data:-
...
https://github.com/prathameshk30/Big-Data-Multivariate-Anamoly-Detection/blob/main/Anomaly_Detection.ipynb
